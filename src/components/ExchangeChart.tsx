...
return {...exchange, percentTotalVolume: parseInt(parseFloat(
exchange.percentTotalVolume).toFixed(1))}
})
...
processedData.push({percentTotalVolume: Math.round(100.0 - restPercentVolume),
name: 'Others'})
